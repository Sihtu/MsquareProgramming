...
var changing = function (event) {
    var value = event.target.value;
    console.log(value);
    input.value = "";
    var menuName = menus
        .filter(function (menu) {
        var inputName = menuCategories.find(function (menucatory) { return menucatory.name.toLowerCase() === value; });
        if (inputName) {
...
var valueName = input.addEventListener("change", changing);
